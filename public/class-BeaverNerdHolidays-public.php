...
class BeaverNerdHolidays_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/BeaverNerdHolidays-public.css', array(), $this->version, 'all' );
	...
	public function register_widget() {
		register_widget( 'BeaverNerdHolidaysWidget' );
	}
